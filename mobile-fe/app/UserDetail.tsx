...
const UserDetail = () => {
    ...
    const genderText = user.gender === 1 ? "Nam" : user.gender === 2 ? "Nữ" : "Chưa cập nhật";
            ...
            { 
                ...
                onPress: async () => {
                    ...
                    try {
                        ...
                        const response = await fetch(`${API_BASE_URL}/admin/delete-user/${user.id}`, {
                            method: "DELETE",
                            headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.infoBox}>
                <Text style={styles.infoLabel}>Vai trò: {user.roles.map((role) => role.name).join(", ")}</Text>
            </View>
            ...
            <View style={styles.infoBox}>
                <Text style={styles.infoLabel}>Trạng thái: <Text style={[styles.status, { color: user.active ? "green" : "red" }]}>
            ...
            <TouchableOpacity 
                ...
                disabled={loading}
            >
                <Text style={styles.deleteButtonText}>{loading ? "Đang xóa..." : "Xóa người dùng"}</Text>
            </TouchableOpacity>
        </View>
    );
};
